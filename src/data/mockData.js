...
export const steps = [
  {
    ...
    desc: 'Tell us where you’re eating. We’ll find real spots near you.',
    color: 'bg-blue-500',
  ...
  },
  {
    ...
    desc: 'Each person shares their restrictions, likes, and dislikes.',
    color: 'bg-violet-500',
  ...
  },
  {
    number: '03',
    icon: '🤖',
    title: 'Find the Middle Ground',
    desc: 'The system compares everyone’s preferences and finds options.',
    color: 'bg-brand-500',
  ...
  },
  {
    ...
    desc: 'Choose from restaraunts that fit the group. Everyone wins!',
    color: 'bg-green-500',
