      ...
      <div className="flex-1 overflow-y-auto px-6 pb-4 min-h-0 space-y-6">
        ...
        <div>
          <p className="text-xs font-bold text-gray-400 uppercase tracking-widest mb-3">
            Dining style <span className="text-gray-300 font-normal normal-case">(pick all that apply)</span>
          </p>
              ...
              return (
                ...
                >
                  ...
                  <div>
                    ...
                    <p
                      className={`text-xs mt-0.5 leading-tight hidden sm:block ${
          ...
          <div className="bg-brand-50 border border-brand-100 rounded-2xl px-4 py-3 flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-brand-600">
                {vibe
                  .map((id) =>
                    VIBE_OPTIONS.find((v) => v.id === id)?.label
                  )
                  .filter(Boolean)
                  .join(' · ')}
              </p>
